...
class MyBookmarkRepositoryTest {
    ...
    class FindBookmarksWithScrollTest {
        ...
        void findFirstPageDescTest() {
            ...
            // when
            List<MyBookmark> result = myBookmarkRepository.findBookmarksWithScroll(member.getId(),
                requestDTO);
        ...
        void findSecondPageTest() {
            ...
            List<MyBookmark> firstPage = myBookmarkRepository.findBookmarksWithScroll(
                member.getId(), firstRequest);
            ...
            // when
            List<MyBookmark> secondPage = myBookmarkRepository.findBookmarksWithScroll(
    ...
    class FindByIdAndMemberIdTest {
        ...
        void findExistingBookmarkSuccess() {
            ...
            MyBookmark foundBookmark = myBookmarkRepository.findByIdAndMemberId(
                ...
                new BookmarkNotFoundException(
                    "해당 북마크를 찾을 수 없습니다. : memberId = " + member.getId() + "bookmarkId ="
                        + " " + savedBookmark.getId()));
        ...
        void findNonExistingBookmarkReturnsNull() {
            // when
            Optional<MyBookmark> result = myBookmarkRepository.findByIdAndMemberId(999999L,
                member.getId());
    ...
    class InsertOtherMemberBookmarkTest {
        ...
        void insertOtherMemberBookmarkSuccess() {
            ...
            assertThat(savedBookmark.getAladinBook().getIsbn13()).isEqualTo(
                otherMemberBookmark.getAladinBook().getIsbn13());
            assertThat(savedBookmark.getPhrase()).isEqualTo(otherMemberBookmark.getPhrase());
            assertThat(savedBookmark.getPageNumber()).isEqualTo(
                otherMemberBookmark.getPageNumber());
        }
        ...
        void insertedBookmarkSharesSameBookReference() {
            ...
            // then
            assertThat(savedBookmark.getAladinBook().getId()).isEqualTo(
                otherMemberBookmark.getAladinBook().getId());
        }
    }
}